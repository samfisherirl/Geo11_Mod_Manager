...
<td><select id="upscalemode" for="upscalemode" data-toggle="tooltip" data-placement="top" title="(Fullscreen and windowed) - enable upscaling and allows the game to disable and enable fullscreen mode
...
.td {
    ...
    font-size:15px;
     ...
     select:hover { 
            ...
            transition: 0.1s;
            box-shadow: rgba(31, 255, 42, 0.751) 0 1px 10px;
